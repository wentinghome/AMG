...
class BertLMPredictionHead(nn.Module):
    def __init__(self, config, bert_model_embedding_weights):
        ...
        self.fp32_embedding = config.fp32_embedding
        # self.type_converter = convert_to_type # I
...
class BertForPreTrainingLossMask(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
        ...
        # sequence_output shape : [4, 267, 768]
        ...
        # sequence_output shape : [4, 267, 768]
        # masked_pos: [4,64]
        # sequence_output_masked: [4, 64, 768] - the masked
        prediction_scores_masked, seq_relationship_score = self.cls(
            sequence_output_masked, pooled_output, task_idx=task_idx) # pooled_output: [4, 768]
        # prediction_scores_masked: [4, 64, vocab_size]
...
class BertForSeq2SeqDecoder(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids, position_ids, attention_mask, task_idx=None, mask_qkv=None):
        ...
        while next_pos < output_length:#这是把输入全部都填进来，464个，最大长度是512，所以summary只有48个token可以生成了。
            ...
            curr_token_type_ids = token_type_ids[:, start_pos:next_pos+1] # 取出一个summary的token_type_id作为summary的新标识
            ...
            # This is compared with the training using bert:
            # sequence_output, pooled_output =
            #   self.bert(input_ids, token_type_ids, attention_mask, output_all_encoded_layers=False, mask_qkv=mask_qkv,
            #     task_idx=task_idx)
